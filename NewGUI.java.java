...
package Package;
	...
	public class GUI extends JFrame implements ActionListener{
	    ...
	    public JFrame initializeBoard(){
	        ...
	        panel2.setBorder(BorderFactory.createTitledBorder (BorderFactory.createEtchedBorder (),"Signale",  TitledBorder.CENTER,TitledBorder.TOP));
	        JPanel panel3 = new JPanel();
	        panel3.setBorder(BorderFactory.createTitledBorder (BorderFactory.createEtchedBorder (),"Stecker",  TitledBorder.CENTER,TitledBorder.TOP));
	    ...
	    public static void main(String[] args) {
	        ...
	        JOptionPane.showMessageDialog(box, "Welcome to Mastermind by SuperBrains. Click 'OK' to start the game.Have fun & good luck!");
